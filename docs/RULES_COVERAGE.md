# Rules Coverage (Engine V1 through Checkpoint 25)
...
- Local React battlefield that displays a redacted player view. Actions go through `GameHost.submit`. Authority persists in localStorage. Not a networked client.
