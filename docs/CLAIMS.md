...
| Activation gates (Verge cycle, legendary/power/attack conditions) | F | claimed | claude/2daf8b18 | comprehensive-plan | 2026-08-21 | Wave 145: `requiresControlled` needs an OR gate (10 Verge lands), plus legendary-creature, min-power, and attacked-with-N conditions — 13 one-away cards |
