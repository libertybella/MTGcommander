...
| Step-trigger timing + intervening-ifs + win conditions | F | claimed | claude/2daf8b18 | comprehensive-plan | 2026-08-21 | Wave 151: upkeep/end_step triggers only ever fire on the controller's own step, so "At the beginning of each end step" compiles to nothing; several common intervening-if conditions and "you win the game" are also missing |
