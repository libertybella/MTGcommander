...
| Static grant lines (anthems, keyword grants, aura pumps) | F | claimed | claude/2daf8b18 | comprehensive-plan | 2026-08-21 | Wave 146: `compileAnthem` handles one shape and returns one ability — needs a subject/predicate grammar returning several (legendary/commander/token/opponent subjects; "gets +N/+N and has X, Y, and Z" predicates) |
